	...
	<view class="setting" :style="{backgroundColor:color.bgPage}">
		...
		<view class="main">
			<u-cell-group :border="false">
				<u-cell-item :border-bottom="false" :title-style="{color:color.normalText}" title="夜间模式" hover-class="cell-hover-class" :arrow="false" :bg-color="color.bgPage">
					<view slot="right-icon"><u-switch v-model="isNight" @change="changeNight" size="40"></u-switch></view>
				</u-cell-item>
				<!-- #ifdef APP-PLUS -->
				<u-cell-item :border-bottom="false" :title-style="{color:color.normalText}" title="检查更新" hover-class="cell-hover-class" :bg-color="color.bgPage" @click="checkAppUpdate" :value="version"></u-cell-item>
				<!-- #endif -->
			</u-cell-group>
		</view>
	</view>
